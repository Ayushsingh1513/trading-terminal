...
/* Pick Cards */
.pick-card{ background:#0D1120; border:1px solid #1E2D47; border-radius:12px; overflow:hidden; transition:transform 0.2s, border-color 0.2s; box-shadow: 0 4px 20px rgba(0,0,0,0.2); }
.pick-card:hover{ border-color:#3B7DFB; transform: translateY(-2px); }
...
.pick-cell-lbl{ font-size:10px; color:#64748B; text-transform:uppercase; letter-spacing:.1em; margin-bottom:4px; font-weight: 60
